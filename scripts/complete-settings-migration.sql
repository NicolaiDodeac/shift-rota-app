-- Complete Settings Migration Script
-- This will add all missing columns to the Settings table
...
-- Update existing records with default values for any NULL columns
UPDATE "Settings" 
SET 
